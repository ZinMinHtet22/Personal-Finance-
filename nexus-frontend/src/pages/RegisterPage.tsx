...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 sm:p-8 relative overflow-hidden bg-slate-50 dark:bg-[#050505]">
      ...
      {/* Glassmorphism Card */}
      <div className="w-full max-w-md relative z-10 p-8 sm:p-12 rounded-[2.5rem] bg-white/80 dark:bg-[#111]/80 backdrop-blur-2xl border border-slate-200/80 dark:border-white/10 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.05)] dark:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.5)] my-8">
        ...
        <div className="mb-10 text-center">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-3 tracking-tight">Request Access</h2>
          <p className="text-slate-500 dark:text-slate-400 font-light">Join the exclusive network of professionals.</p>
        </div>
        ...
        <p className="mt-8 text-center text-slate-500 dark:text-slate-400 text-sm font-light">
          Already have an account? <Link to="/login" className="text-slate-900 dark:text-white hover:underline font-medium transition-colors ml-1">Sign In</Link>
        </p>
      </div>
    </div>
  );
